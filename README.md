...
```javascript
discreteUniform = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-discrete-uniform@umd/browser.js' )
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/random-discrete-uniform/tags). For example,

```javascript
discreteUniform = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/random-discrete-uniform@v0.1.0-umd/browser.js' )
```

To vendor stdlib functionality and avoid installing dependency trees for Node.js, you can use the UMD server build:

```javascript
var discreteUniform = require( 'path/to/vendor/umd/random-discrete-uniform/index.js' )
```
...
#### discreteUniform( shape, a, b\[, options] )

Returns an [ndarray][@stdlib/ndarray/ctor] containing pseudorandom numbers drawn from a [discrete uniform][@stdlib/random/base/discrete-uniform] distribution.

```javascript
var arr = discreteUniform( [ 3, 3 ], -10, 10 );
// returns <ndarray>
```
...
var arr = discreteUniform( [ 2, 3, 3 ], a, b );
// returns <ndarray>
```
...
var arr = discreteUniform( [ 3, 3 ], -10, 10, opts );
// returns <ndarray>
...
Fills an [ndarray][@stdlib/ndarray/ctor] with pseudorandom numbers drawn from a [discrete uniform][@stdlib/random/base/discrete-uniform] distribution.
...
var v = discreteUniform.assign( -10, 10, out );
// returns <ndarray>
...
#### discreteUniform.factory( \[options] )

Returns a function for generating pseudorandom numbers drawn from a [discrete uniform][@stdlib/random/base/discrete-uniform] distribution.
...
var random = discreteUniform.factory( opts );
...
The function returned by the `factory` method has the same interface and accepts the same options as the `discreteUniform` function above.
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/random-discrete-uniform.svg
[npm-url]: https://npmjs.org/package/@stdlib/random-discrete-uniform

[test-image]: https://github.com/stdlib-js/random-discrete-uniform/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/random-discrete-uniform/actions/workflows/test.yml?query=branch:v0.1.0

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/random-discrete-uniform/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/random-discrete-uniform?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/random-discrete-uniform.svg
[dependencies-url]: https://david-dm.org/stdlib-js/random-discrete-uniform/main
...
[deno-url]: https://github.com/stdlib-js/random-discrete-uniform/tree/deno
[deno-readme]: https://github.com/stdlib-js/random-discrete-uniform/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/random-discrete-uniform/tree/umd
[umd-readme]: https://github.com/stdlib-js/random-discrete-uniform/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/random-discrete-uniform/tree/esm
[esm-readme]: https://github.com/stdlib-js/random-discrete-uniform/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/random-discrete-uniform/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/random-discrete-uniform/main/LICENSE
