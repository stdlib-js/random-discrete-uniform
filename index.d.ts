...
interface RandomFunction extends PRNG {
	/**
	* Returns an ndarray containing pseudorandom numbers drawn from a discrete uniform distribution.
	*
	...
	*/
	...
	/**
	* Fills an ndarray with pseudorandom numbers drawn from a discrete uniform distribution.
	*
	* @param a - minimum support
	* @param b - maximum support
...
interface Random extends PRNG {
	...
	*
	* @example
	* var out = discreteUniform( [ 3, 3 ], -10, 10 );
	* // returns <ndarray>
	*/
	<T extends typedndarray<number>, U extends typedndarray<number>>( shape: Shape, a: number | T, b: number | U, options?: Options ): RandomArray;
	...
	*/
	...
	/**
	* Returns a function for creating ndarrays containing pseudorandom numbers drawn from a discrete uniform distribution.
	*
	* @param options - function options
